...
public class MoneyUtil {
	...
	private static Log log = LogFactory.getLog(MoneyUtil.class);
	...
	*/
	  ...
	  public static void main(String[] args) {
	    System.out.println(MoneyUtil.toBigAmt(10052345.00D));
	    System.out.println(MoneyUtil.toBigAmt(0.00D));
	    System.out.println(MoneyUtil.toBigAmt(0.60D));
	    System.out.println(MoneyUtil.toBigAmt(00.60D));
	    System.out.println(MoneyUtil.toBigAmt(150.2101D));
	    System.out.println(MoneyUtil.toBigAmt(15400089666.234D));
	    System.out.println(MoneyUtil.toBigAmt(22200004444.2347D));
	    System.out.println(MoneyUtil.toBigAmt(5000.25));
	  }
    /**
     * 金额为分转元
     * */    
    public static String changeF2Y(long m){    
        return BigDecimal.valueOf(m).divide(new BigDecimal(100)).toString();    
    }
	 ...
	 * @return
	 */
	public static String customMoneyFormat(Long val) {
		if (Objects.isNull(val)) {
			return "0元";
		}
		String result;
		if(val < 1000000L) {
			DecimalFormat formatMega = new DecimalFormat("0.##");
			BigDecimal bdMega = new BigDecimal(val).movePointLeft(2);
			result = formatMega.format(bdMega)+ "元";
		}else{
			DecimalFormat formatMega = new DecimalFormat("0.#");
			BigDecimal bdMega = new BigDecimal(val).movePointLeft(4).movePointLeft(2);
			result = formatMega.format(bdMega)+ "万元";
		}
       return result;
	}
}